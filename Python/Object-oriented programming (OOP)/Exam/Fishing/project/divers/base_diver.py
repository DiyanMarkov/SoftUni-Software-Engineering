...
class BaseDiver(ABC):
    ...
    @property
    def get_competition_points(self):
        result = round(float(self.competition_points), 1)
        return result
    ...
    def update_health_status(self):
        return self.has_health_issue if not self.has_health_issue else not self.has_health_issue
